...
export default function HowToUse() {
  return (
    <div className="mx-auto my-[80px] text-center text-white">
        <h2 className="text-[48px] font-bold bg-[#1a1a1a] pt-[40px]">
          How to use <span className="text-[#C3FF73]">B2D</span> Venture?
        </h2>
      {/* Investor Section */}
      <div className="bg-[#1a1a1a] py-10 px-6 shadow-lg">
        <p className="mb-12 mx-auto max-w-[700px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:space-x-20">
          <div className="flex flex-col items-center">
            <img src={step1} alt="Step 1" className="w-[24px] mb-8" />
            <img src={invest} alt="Invest" className="w-[36px] h-[36px] mb-8" />
          ...
          <div className="flex flex-col items-center">
            <img src={step2} alt="Step 2" className="w-[24px] mb-8" />
            <img src={pending} alt="Pending" className="w-[36px] h-[36px] mb-8" />
            <p className="text-center">
          ...
          <div className="flex flex-col items-center">
            <img src={step3} alt="Step 3" className="w-[24px] mb-8" />
            <img src={admin} alt="Admin" className="w-[36px] h-[36px] mb-8" />
            <p className="text-center">
      ...
      {/* Startup Section */}
      <div className="bg-[#2c2c2c] pt-[40px] pb-[50px] px-6 shadow-lg">
        <p className="mb-12 mx-auto max-w-[700px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:space-x-20">
          <div className="flex flex-col items-center">
            <img src={step1} alt="Step 1" className="w-[24px] mb-8" />
            <img src={register} alt="Register" className="w-[36px] h-[36px] mb-8" />
            <p className="text-center">
          ...
          <div className="flex flex-col items-center">
            <img src={step2} alt="Step 2" className="w-[24px] mb-8" />
            <img src={decision} alt="Decision" className="w-[36px] h-[36px] mb-8" />
            <p className="text-center">
